                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{ route('admin.projects.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            <i class="btn-susces"></i>tambah Project</a>
                    </div>
                    ...
                    <table id="projectsTable" border="1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset('storage/' . $item->image) }}" alt="Image" style="max-width: 60px;"></td>
                                <td>{{ $item->issued_at }}</td>
                                <td class="py-2 px-4 border d-flex">
                                    <!-- Tombol Edit -->
                                    <a href="{{ route('admin.projects.edit', $item->id) }}" class="btn btn-warning text-white" onclick="return confirmEdit()">Edit</a>
                                
                                    <!-- Form untuk Delete -->
                                    <form id="deleteForm-{{ $item->id }}" action="{{ route('admin.projects.destroy', $item->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
