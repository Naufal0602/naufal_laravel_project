...
<body class="bg-light">
    ...
    <div class="container py-5">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <!-- Form -->
                <form id="contactForm" action="{{ route('admin.contact.update', $contact->id) }}" method="post">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="mail" id="mail" class="form-control" value="{{ $contact->mail }}" required>
                    </div>
    ...
    <script>
        function confirmSubmit() {
            Swal.fire({
                ...
                text: "Apakah Anda ingin memperbarui kontak ini?",
                icon: "warning",
