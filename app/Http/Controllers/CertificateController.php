...
class AdminCertificateController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard', compact('certificate')); // Send the $home data to the view
    ...
    {
        return view('dashboard'); // Adjusted to 'home.create'
    }
    ...
    public function submit_home(Request $request)
{
    ...
    return redirect()->route('dashboard')->with('success', 'Home successfully saved!');
}
